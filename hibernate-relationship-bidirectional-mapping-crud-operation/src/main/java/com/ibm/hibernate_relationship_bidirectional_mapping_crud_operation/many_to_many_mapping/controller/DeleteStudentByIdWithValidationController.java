...
public class DeleteStudentByIdWithValidationController {
	private static final Logger log = LoggerUtil.getLogger(DeleteStudentByIdWithValidationController.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			dao.deleteStudentIdWithValidation(studentId);
			...
			log.error("Unexpected error while deleting students details", e);
		}
