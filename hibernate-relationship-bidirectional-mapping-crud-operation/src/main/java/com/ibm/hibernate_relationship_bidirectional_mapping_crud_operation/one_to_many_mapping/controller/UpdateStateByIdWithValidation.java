...
public class UpdateStateByIdWithValidation {
	
	private static final Logger log = LoggerFactory.getLogger(UpdateStateByIdWithValidation.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			String capital = "Edgbaston";
			boolean isUpdated = dao.updateStateByIdWithValidation(stateToUpdate, name, capital);
			
			if(isUpdated) {
				log.info("State with ID {} updated successfully.", stateToUpdate);;
			} else {
				log.warn("No State found with ID {}", stateToUpdate);
			}
